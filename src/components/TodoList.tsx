    ...
    function Options() {
        return (
            <div className='option'>
                <div onClick={() => { setModal(true) }}>수정</div>
                <div>삭제</div>
            </div>
        )
    }
        ...
        <>
            <div className='todo'>
                <div className='checkbox'>
                    <div className='check' onClick={() => { onClickEvent() }}>{chk ? <Check/> : ""}</div>
                    <span className={chk ? "overline" : ""}>
                        {title}
                    </span>
                </div>
            ...
            {modal && <ModifyModal onClose={() => { setModal(false) }}/>}
        </>
    )
}
